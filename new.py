...
if selected == "Home":
    with st.expander('Kidney'):
        st.image('C:/Users/m6320/Downloads/kidney-stock.jpg')   
    ...
    with st.expander('Liver'):
        st.image('C:/Users/m6320/Downloads/images.jpeg')
    ...
    with st.expander('Parkinsons'):
        st.image('C:/Users/m6320/Downloads/NIA_Brain_Medical_Graphic_for_Parkinsons_Disease_102721_500px-02.png')
